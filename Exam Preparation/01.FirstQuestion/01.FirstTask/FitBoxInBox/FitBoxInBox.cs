...
class FitBoxInBox
{
    ...
    {
        if (firstWidth < secondWidth && firstHeight < secondHeight && firstDepth < secondDepth) // тук приемам, че първата е по-малка от втората.После си викам метода и проверявам всички възможности.
        {
